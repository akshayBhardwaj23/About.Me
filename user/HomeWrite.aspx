<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/user/MasterPage.master" AutoEventWireup="true" CodeFile="HomeWrite.aspx.cs" Inherits="user_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid page-header">
        <h1><small>
            <asp:Label ID="Label1" runat="server" Text="Add new Post"></asp:Label></small></h1>
    </div>
    <div class="container">
        <div class="row">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-control-static">                        
                        <div class="col-sm-offset-2 col-sm-10">
                            <!--<button id="btn1" type="submit" class="btn btn-success" onclick="btn1_Click">Submit</button>&nbsp;&nbsp;&nbsp;<button id="btn2" type="submit" class="btn btn-default" onclick="btn2_Click">Cancel</button>-->
                            <asp:Button ID="btn1" CssClass="btn btn-success" runat="server" Text="Submit" OnClick="btn1_Click1" />&nbsp;&nbsp;&nbsp;
